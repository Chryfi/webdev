    ...
    <main class="container-sm">
        <div class="search-katzegorien-container">
            <form class="gap-y-1" method="GET">
                ...
                <div>
                    <button class="dropdown-button dropdown-button-arrow dropdown-button-classic
                    row align-items-center <?php if (!$isAdvancedSearch) echo 'collapsed'; ?>" data-dropdown-target="extended-search">
