                ...
                <div class="blog-head row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="row blog-info-container">
                            ...
                            <div class="col">
                                <button class="display-sm-none dropdown-button dropdown-button-arrow dropdown-button-classic row align-items-center collapsed" data-dropdown-target="tag-list">
